sap.ui.define([
	...
	const initialValues = {
		...
		return BaseController.extend("incidentspa32597u00ui.controller.Create", {
            onInit: function () {
        ...
        uploadPicture: function (response) {
			...
			xhr.open("PUT", "/incident/IncidentPhotos(" + id + ")/image");
